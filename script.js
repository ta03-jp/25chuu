...
function showScreen(index) {
  ...
  if (index === 0) {
    ...
    updateIndicator(0); // scr2と同じインジケーターを使う場合
  }
}
...
const dress_outcamera = document
  .getElementById("dress_outcamera")
  .addEventListener("click", () => {
    isFrontCamera = !isFrontCamera;
    startCamera();
    setSelection("dress");
...
let bottomstemp = [
  ...
  {
    name: "ロングスカート",
    src: "images/longskirt_icon.png",
    front: "images/longskirt_front.png",
    back: "",
  },
];
let dresstemp = [
  {
    name: "ワンピース",
    src: "images/hoodie_icon.png",
    front: "images/longcoat_front.png",
    back: "images/longcoat_back.png",
    sleeve: "images/longcoat_sleeve.png",
  },
];
let katagamiFreamchangefront = "images/longcoat_front.png";
let katagamiFreamchangeback = "images/longcoat_back.png";
let katagamiFreamchangesleeve = "images/longcoat_sleeve.png";
let templateName = "テンプレート名";

//トップス確定　scr15
const confirmNext = document
  .getElementById("confirmNext")
  .addEventListener("click", () => {
    ScreenTransition(2);
    //服の種類決定-->テンプレート選択画面に遷移
  });

// scr16の「次へ進む」ボタン → scr2へ遷移

// 画像の通常版とグレー版を管理
const images = {
  tops: { normal: "images/topsbtn.png", gray: "images/topsgray.png" },
  bottoms: { normal: "images/bottomsbtn.png", gray: "images/bottomsgray.png" },
  dress: { normal: "images/dressbtn.png", gray: "images/dressgray.png" },
};

// 選択状態を更新する関数
function setSelection(selected) {
  // まず全てを通常画像に戻す
  document.getElementById("topsImg").src = images.tops.normal;
  document.getElementById("bottomsImg").src = images.bottoms.normal;
  document.getElementById("dressImg").src = images.dress.normal;

  // 選択されたものだけグレー画像に変更
  document.getElementById(selected + "Img").src = images[selected].gray;
}

// 各ボタンにイベントを設定
document
  .getElementById("topsBtn")
  .addEventListener("click", () => setSelection("tops"));
document
  .getElementById("bottomsBtn")
  .addEventListener("click", () => setSelection("bottoms"));
document
  .getElementById("dressBtn")
  .addEventListener("click", () => setSelection("dress"));
...
function resetConfirmType() {
  document.getElementById("topsImg").src = "images/topsbtn.png";
  document.getElementById("bottomsImg").src = "images/bottomsbtn.png";
  document.getElementById("dressImg").src = "images/dressbtn.png";
}
...
function katagamiEvent() {
  ...
  if (katagami == 1) {
    ...
    document.querySelector(".f_area").style.width = "100%";
  } else if (katagami == 2) {
    //ボトムスの場合
    data = null;
    //初期化してから入れる
...
//撮影終了後　scr16
const confirmTemp = document
  .getElementById("confirmTemp")
  .addEventListener("click", () => {
    ScreenTransition(3);
    //テンプレート決定-->撮影時の注意に遷移
  });
