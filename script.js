...
//   // グレー画像に差し替え
//   const selectedImg = document.getElementById("selectedTypeImg");
//   if (type === "tops") {
//     selectedImg.src = "images/topsgray.png";
//   } else if (type === "bottoms") {
//     selectedImg.src = "images/bottomsgray.png";
//   } else if (type === "dress") {
//     selectedImg.src = "images/onegray.png";
//   }

//   // scr1.5へ遷移
//   ScreenTransition(15); // scr1.5のindex番号
// }

// // scr1.5の「次へ進む」ボタン
// document.getElementById("confirmNext").addEventListener("click", () => {
//   if (selectedType !== "") {
//     ScreenTransition(2); // scr2へ遷移
//   }
// });
